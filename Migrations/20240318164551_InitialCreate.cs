    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CueItem", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CueItem_Artist_ArtistId",
                        column: x => x.ArtistId,
                        principalTable: "Artist",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CueItem_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "RequestId");
                    table.ForeignKey(
                        name: "FK_CueItem_Songs_SongId",
                        column: x => x.SongId,
                        principalTable: "Songs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenreSong", x => new { x.GenresGenreId, x.SongsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CueItem_ArtistId",
                table: "CueItem",
                column: "ArtistId");

            migrationBuilder.CreateIndex(
                name: "IX_CueItem_RequestId",
                table: "CueItem",
                column: "RequestId");

            migrationBuilder.CreateIndex(
                name: "IX_CueItem_SongId",
                table: "CueItem",
                column: "SongId");
